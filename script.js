...
const I18N = {
  ...
  ru: {
    ...
    'about.bio':         'Привет, меня зовут Виталик, я оператор-постановщик из Москвы, родился 4 апреля 1997 года. Работаю в широком спектре форм и жанров, таких как кино, реклама, музыкальные клипы. Окончил Московскую школу кино, имею богатый опыт работы на больших площадках, некоторые мои фильмы получали награды на фестивалях. Отдельная любовь — однокадровые постановки.',
