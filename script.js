...
const I18N = {
  ...
  ru: {
    ...
    'about.bio':         'Виталий Смалько — оператор-постановщик из Москвы, родился 4 апреля 1997 года. Работает в широком спектре форм, таких как кино, клипы и реклама. Окончил Московскую школу кино, имеет большой опыт съёмок на крупных постановочных проектах и снимает на любую камеру — отдельная любовь — однокадровые постановки. Его короткометражные фильмы показывались на фестивалях, один из них отмечен призом за лучшую операторскую работу.',
